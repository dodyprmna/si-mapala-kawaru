...
<html lang="en">
<head>
	<title>Administrasi Mapala Kawaru</title>
	<meta charset="UTF-8">
...
<body>
	<div class="limiter">
		<div class="container-login100" style="background-image: url(<?= base_url('assets/login_page/images/bg.jpg')?>);">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					SISTEM ADMINISTRASI MAPALA KAWARU
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" method="post" action="<?= base_url('Auth/login')?>">
